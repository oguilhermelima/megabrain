...
// The dispatch states a coordinator still expects progress from, used to decide which dispatches
// the turn-end hook's parent-notify scan should look at at all.
