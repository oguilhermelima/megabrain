...
- Run megabrain install [module-id] [--agents claude,codex,agy|none] [--skill none|global|project] [--agents-md none|global|project] [--modules list|all|none] [--yes] [--browser chromium|firefox|both] [--revert].
